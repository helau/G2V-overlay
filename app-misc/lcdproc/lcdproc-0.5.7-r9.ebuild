...
EAPI=5
inherit multilib versionator systemd autotools
...
IUSE_LCD_DEVICES=(activy3 ncurses bayrad cfontz cfontzpacket
	cwlinux dm140 eyeboxone g15 graphlcd glk
...
src_prepare() {
	...
	epatch "${FILESDIR}"/cvs-lcd_activy3dm140.patch
	cp "${FILESDIR}"/autogen.sh .
	sh ./autogen.sh
	eautoreconf
}
...
src_configure() {
	...
	local DEVICE_DRIVERS=(activy3 curses bayrad CFontz CFontzPacket
		CwLnx dm140 EyeboxOne g15 glcd,glcdlib glk
